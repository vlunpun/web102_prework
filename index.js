...
raisedCard.innerHTML = `$${totalPledges.toLocaleString()}`;
...
const displayStr = `A total of $${totalPledges.toLocaleString()} has been raised for ${GAMES_JSON.length} games. 
Currently, ${unfundedCount === 1 ? "1 game remains" : `${unfundedCount} games remain`} unfunded. We need your 
